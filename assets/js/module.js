...
export const mps_to_kmh = mps => {
 ...
 export const aqiText = {
    ...
    3: {
        level: "Moderate",
        message: "Members of sensitive groups may experiences health efects. The general public is not likely to be affected."
    },
    4: {
        level: "Poor",
        message: "Everyone may begin to esperience health effects; members of sensitive groups may experience more serious health effects."
    },
    5: {
        level: "Very Poor",
        message: "Air quality is acceptable; however, for some pollutants there may be a moderate health concern for a very small number of people who are unusually sensitive to air pollution."
